...
import pl.edu.agh.marims.lib.network.sender.AsyncTaskSender;
import pl.edu.agh.marims.lib.network.sender.SenderType;
import pl.edu.agh.marims.lib.network.sender.TcpSocketSender;
import pl.edu.agh.marims.lib.network.sender.UdpSocketSender;
